...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        await query.message.edit_text(
            ...
            cnlbtn = [[
                      InlineKeyboardButton('Lᴜᴄɪғᴇʀ Bᴏᴛ Lᴏɢs', url="https://t.me/Shazam_bot_support")
                     ], [
                      InlineKeyboardButton('Gʀᴏᴜᴘ', url='t.me/Cinemaa_moviess'),
                      InlineKeyboardButton('Cʜᴀɴɴᴇʟ', url='t.me/Cinemaa_boxoffice_support')
                     ], [
                      InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ', url='t.me/Shazam_bot_support'),
                      InlineKeyboardButton('Uᴘᴅᴀᴛᴇs', url='t.me/cinemaa_must_hai')
                     ], [
                      InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="start")
                     ]]
